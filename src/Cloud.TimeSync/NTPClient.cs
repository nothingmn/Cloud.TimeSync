...
namespace Cloud.TimeSync
{
    ...
    public class NTPClient
    {
        ...
        public void Connect(bool UpdateSystemTime, int sendTimeout= 2000, int receiveTimeout = 2000)
        {
            try
            {
                ...
                TimeSocket.Client.SendTimeout = sendTimeout;
                TimeSocket.Client.ReceiveTimeout = receiveTimeout;
        ...
        private void SetTime()
        {
            ...
            var success = SetLocalTime(ref st);

            if (!success)
            {
                var error = System.Runtime.InteropServices.Marshal.GetLastWin32Error();
                Trace.WriteLine($"ERROR SETTING LOCAL TIME, GetLastWin32Error:{error}");
            }
        }
